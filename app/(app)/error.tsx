...
export default function ApplicationError({
  ...
  return (
    <div className="max-w-2xl border-y border-rose-500/20 py-10">
      ...
      <button
        className="mt-7 inline-flex min-h-11 items-center gap-2 rounded-sm border border-black/[0.08] px-5 py-3 text-[11px] font-bold tracking-[0.1em] uppercase dark:border-white/[0.08]"
        onClick={reset}
        type="button"
      >
