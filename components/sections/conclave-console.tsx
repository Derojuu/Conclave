  ...
  return (
    <div className="relative overflow-hidden rounded-sm border border-black/[0.07] bg-[#EBE8E1] shadow-[0_30px_80px_rgba(0,0,0,0.16)] dark:border-white/[0.08] dark:bg-[#111]">
      ...
      <div className="relative z-10 flex h-12 items-center justify-between border-b border-black/[0.06] px-4 sm:px-5 dark:border-white/[0.07]">
        ...
        <p className="truncate px-3 text-[10px] font-bold tracking-[0.14em] text-zinc-500 uppercase sm:text-[11px]">
      ...
      <div className="relative z-10 grid grid-cols-[0.76fr_1.24fr]">
        <section className="border-r border-black/[0.06] p-3 sm:p-5 dark:border-white/[0.07]">
          <div className="flex items-end justify-between gap-2">
            <div>
              <p className="text-[9px] tracking-[0.12em] text-zinc-500 uppercase sm:text-[10px]">
                Evaluator activity
              </p>
            ...
            {evaluators.map(([number, role]) => (
              ...
              >
                <div className="flex min-w-0 items-center gap-2 sm:gap-3">
                  <span className="flex h-6 w-6 shrink-0 items-center justify-center border border-black/[0.08] text-[9px] font-bold text-zinc-500 dark:border-white/[0.08]">
                    {number}
                  </span>
                  <div className="min-w-0">
                    <p className="hidden truncate text-[10px] font-bold tracking-[0.06em] text-zinc-800 uppercase sm:block dark:text-zinc-200">
                      {role}
                    </p>
                    <p className="text-[9px] text-zinc-500 uppercase sm:mt-1 sm:text-[9px]">
                      Input private
                    </p>
                  </div>
                </div>
        ...
        <section className="relative min-w-0 p-3 sm:p-5">
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <p className="mt-1 hidden text-[11px] font-bold text-zinc-900 uppercase sm:block dark:text-white">
                Approved policy / Weighted aggregate
              </p>
            </div>
            <span className="border border-indigo-500/20 bg-indigo-500/[0.05] px-2 py-1 text-[9px] font-bold tracking-[0.08em] text-indigo-500 uppercase">
              Protected
            </span>
          </div>
          ...
          <div className="relative mt-4 grid min-h-40 grid-cols-[1fr_auto_1fr] items-center gap-2 border-y border-black/[0.06] py-5 sm:min-h-44 sm:gap-5 dark:border-white/[0.06]">
            <div className="relative z-10 min-w-0">
              <p className="text-[9px] leading-tight font-bold tracking-[0.1em] text-zinc-500 uppercase">
                Encrypted bundle
              </p>
              ...
              <p className="mt-3 hidden font-mono text-[9px] text-zinc-500 sm:block">
                0x8f...c21
              </p>
            </div>
            ...
            <div className="relative z-10 min-w-0 text-right">
              <p className="text-[9px] leading-tight font-bold tracking-[0.1em] text-emerald-500 uppercase">
                Verified result
              </p>
              <p className="mt-3 truncate text-xs font-bold text-zinc-950 uppercase sm:text-sm dark:text-white">
                Northstar
              </p>
              <p className="mt-1 hidden text-[9px] text-zinc-500 uppercase sm:block">
                Recommended
              </p>
          ...
          <div className="mt-4 grid grid-cols-5">
            {stages.map((stage, index) => (
              <div className="flex min-w-0 flex-col items-center" key={stage}>
                ...
                <span className="mt-2 hidden text-[9px] text-zinc-500 sm:block">
                  {stage}
                </span>
              </div>
            ))}
      ...
      <div className="relative z-10 flex h-9 items-center justify-between gap-4 border-t border-black/[0.06] px-4 sm:px-5 dark:border-white/[0.07]">
        ...
        <span className="shrink-0 text-[9px] font-bold tracking-[0.08em] text-emerald-500 uppercase">
          06 confirmations
        </span>
      </div>
    </div>
