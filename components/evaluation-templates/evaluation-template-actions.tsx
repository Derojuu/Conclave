  ...
  return (
    <section className="mt-10 border-y border-black/[0.06] py-7 dark:border-white/[0.06]">
      <div className="grid gap-3 sm:grid-cols-2">
        <button
          className="inline-flex min-h-11 items-center justify-center gap-2 border border-black/[0.08] px-4 text-[8px] font-bold tracking-[0.08em] uppercase hover:border-indigo-500 hover:text-indigo-500 disabled:opacity-50 dark:border-white/[0.08]"
      ...
      <div className="mt-8 border-t border-black/[0.06] pt-7 dark:border-white/[0.06]">
        ...
        <div className="mt-2 flex flex-col gap-3 sm:flex-row">
          <input
            className="h-11 min-w-0 flex-1 border border-rose-500/20 bg-rose-500/[0.02] px-3 text-[10px] outline-none focus:border-rose-500 disabled:opacity-50"
          ...
          />
          <button
            className="inline-flex min-h-11 items-center justify-center gap-2 bg-rose-600 px-5 text-[8px] font-bold tracking-[0.1em] text-white uppercase disabled:opacity-40"
            disabled={
              !canDelete ||
