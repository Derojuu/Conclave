...
export function OrganizationSwitcher({
  ...
  return (
    <div className="relative min-w-0">
      ...
      <select
        className="h-9 w-[104px] truncate border border-black/[0.07] bg-transparent px-2 pr-7 text-[10px] font-bold text-zinc-600 outline-none focus:border-indigo-500 min-[380px]:w-[136px] sm:w-[190px] dark:border-white/[0.07] dark:text-zinc-300"
        disabled={isPending}
